...
| `REPORT_IMAGE_MAX_WIDTH` | `800`                                                 | —                              | Width photos are scaled to before being base64-inlined into the report |
...
| Application logs  | `logs/`               | `/app/logs`     | Backend rolling log (`home-inspection.log`, 10 MB × 14 days), gitignored. pdf-service errors only go to `docker compose logs pdf-service` |
